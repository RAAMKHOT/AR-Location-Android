...
open class ARActivity() : AppCompatActivity(), EasyPermissions.PermissionCallbacks, SensorEventListener, LocationListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.toolbarParent.btnNavigate.setOnClickListener {
         finish()
        }
        binding.toolbarParent.txtToolbarTitle.text = "AR Locations"
        binding.toolbarParent.txtToolbarTitle.textSize = 16f
        binding.toolbarParent.txtToolbarTitle.setTypeface(null, Typeface.BOLD)

        cameraExecutor = Executors.newSingleThreadExecutor()

        val window: Window = this.window
        window.statusBarColor = Color.parseColor("#FF000000");//#DB7000
    }
