                    ...
                    if (radiusInMeter != null && places[i].distance!! <= radiusInMeter) {
                        ...
                        if (arPointLayouts.size <= i) {
                            ...
                            if (places[i].name != null) {
                                ...
                                if (places[i].name.equals("ATM")) {
                                    Glide.with(this)
                                        .load(this.resources.getDrawable(R.drawable.atm_location_64))
                                        .into(arPointIcon)
                                } else {
                                    Glide.with(this)
                                        .load(this.resources.getDrawable(R.drawable.branch_location_68))
                                        .into(arPointIcon)
                                }
                            }
                            ...
                            arPointDescription.visibility = GONE
